...
const init = () => {
  render(mainControlElement, getMenu(), `beforeend`);
  render(mainElement, getFilters(), `beforeend`);
  render(mainElement, getBoard(), `beforeend`);

  const boardElement = mainElement.querySelector(`.board`);
  render(boardElement, getSorting(), `beforeend`);
  render(boardElement, getBoardForTasks(), `beforeend`);

  const boardTasksElement = boardElement.querySelector(`.board__tasks`);
  render(boardTasksElement, getEditTask());
  render(boardTasksElement, getTask(), `beforeend`);
  render(boardTasksElement, getLoadMore(), `afterend`);
};
